...
function rotateHeader() {
  ...
  if ((0 <= degree && degree < 90) || (270 <= degree && degree < 360)) {
    question.className = 'face';
  } else {
    question.className = 'back';
  }
  question.style.transform = 'rotateY(' + degree + 'deg)';
}
...
assessmentButton.onclick = () => {
  ...
  anchor.innerText = 'Twwet #あなたのいいところ';
...
'{userName}のいいところは節度です。強引すぎない{userName}の考えに皆が共感しています。',
'{userName}のいいところは好奇心です。新しいことに向かっていく{userName}の心構えが多くの人に魅力的に移ります。',
'{userName}のいいところは気配りです。{userName}の配慮が多くの人を救っています。',
'{userName}のいいところはその全てです。ありのままの{userName}地震がいいところなのです。',
...
/**
 * 名前の文字列を渡すと診断結果を返す関数
 * @param {string} userName ユーザーのなまえ
 * @return {string} 診断結果
 */
